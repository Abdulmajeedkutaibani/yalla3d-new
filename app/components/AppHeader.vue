...
<template>
  ...
  >
    <div class="flex flex-row w-full flex-nowrap items-center gap-2">
      <NuxtLink
        aria-label="Home"
        class="flex items-center justify-center min-w-[52px] min-h-[52px] max-lg:min-w-12 max-lg:min-h-12 hover:bg-black/5 hover:dark:bg-white/15 max-lg:dark:bg-white/90 max-lg:bg-black/5 max-lg:hover:bg-black/10 max-lg:hover:dark:bg-white/20 rounded-2xl max-lg:rounded-full transition active:scale-95"
        :to="localePath('/')"
      >
        <img
          class="rounded-lg max-lg:rounded-full bg-[#3a0f5c] w-12 h-12"
          src="/Yalla3D.svg"
          alt="Logo"
          loading="lazy"
          title="logo"
